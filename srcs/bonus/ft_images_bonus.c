...
/*   Updated: 2023/08/18 18:01:41 by jebouche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	refresh_images(t_cubed *cubed)
{
	...
	mlx_put_image_to_window(cubed->mlx, cubed->window, ((t_cubed_bonus *)cubed)->minimap_img->img, 60, 763); //TODO make macro for this
	mlx_put_image_to_window(cubed->mlx, cubed->window, ((t_cubed_bonus *)cubed)->mini_player_img->img, 60, 763);
